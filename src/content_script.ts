import { addMetricsButton, renderMetrics } from './rendering';
import Config from './config';
import { DRAFT, MERGED, NEW, OLD, OUTSTANDING, READY_FOR_REVIEW, REOPENED, REVIEW_REQUESTED } from './constants';

console.log('[github-metrics] chrome extension loaded');

const config = new Config();

addMetricsButton(config);
